...
namespace Gma.System.Windows
{
    ...
    public class UserActivityHook
    {
        ...
        /// </remarks>
        public UserActivityHook(bool InstallMouseHook, bool InstallKeyboardHook, PresentationSource source)
        {
        ...
        private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (OnMouseActivity != null))
            {
                ...
                MouseEventArgs e = new MouseEventArgs(InputManager.Current.PrimaryMouseDevice, 0);
                ...
                //MouseDevice device = new mouse
                

                //MouseButtonEventArgs e = new MouseButtonEventArgs(InputManager.Current.PrimaryMouseDevice, 0, button);
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null/* || KeyPress != null*/))
            {
                ...
                {
                    Trace.WriteLine(MyKeyboardHookStruct.vkCode);
                    Key keyData = KeyInterop.KeyFromVirtualKey(MyKeyboardHookStruct.vkCode);
                    KeyEventArgs e = new KeyEventArgs(InputManager.Current.PrimaryKeyboardDevice, this.presentationSource, 0, keyData);
                ...
                //        KeyEventArgs e = new KeyEventArgs(InputManager.Current.PrimaryKeyboardDevice, InputManager.Current.PrimaryKeyboardDevice.ActiveSource, 0, keyData);
                //        e.RoutedEvent = Keyboard.KeyDownEvent;
                //        handled = handled || e.Handled;
                //    }
                //}
